materialAdmin 
    ...
    //PARA VIEW DE PAQUETES

    .directive('accommodationOverflow', ['nicescrollService', function(nicescrollService){
        return {
            restrict: 'C',
            link: function(scope, element) {
        
                if (!$('html').hasClass('ismobile')) {                    
                    nicescrollService.niceScroll(element, 'rgba(0, 128, 128, 0.55)', '5px', 'rgba(0, 128, 128, 0.37)');
                }
            }
        }
    }])
